...
if(typeof define == 'function' && define.cmd){
	define('fnx/cmp/base/base',['fnx/cmp/class/class','fnx/cmp/events/events'],function(require){
		__include__['class/class'] = require('fnx/cmp/class/class');
		__include__['events/events'] = require('fnx/cmp/events/events');
		return __using__('base/base');
	});
}
