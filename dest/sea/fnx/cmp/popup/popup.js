...
if(typeof define == 'function' && define.cmd){
	define('fnx/cmp/popup/popup',['$','fnx/cmp/overlay/overlay','fnx/cmp/overlay/mask'],function(require){
		require('$');
		__include__['$'] = $;
		__include__['overlay/overlay'] = require('fnx/cmp/overlay/overlay');
		__include__['overlay/mask'] = require('fnx/cmp/overlay/mask');
		return __using__('popup/popup');
	});
}
