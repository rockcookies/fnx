...
if(typeof define == 'function' && define.cmd){
	define('fnx/cmp/overlay/overlay',['$','fnx/cmp/position/position','fnx/cmp/iframe-shim/iframe-shim','fnx/cmp/widget/widget'],function(require){
		require('$');
		__include__['$'] = $;
		__include__['position/position'] = require('fnx/cmp/position/position');
		__include__['iframe-shim/iframe-shim'] = require('fnx/cmp/iframe-shim/iframe-shim');
		__include__['widget/widget'] = require('fnx/cmp/widget/widget');
		return __using__('overlay/overlay');
	});
}
